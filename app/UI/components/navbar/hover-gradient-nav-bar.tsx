...
const menuItems: HoverGradientMenuItem[] = [
    {
        ...
        href: "/",
        gradient:
            "radial-gradient(circle, rgba(59,130,246,0.2) 0%, rgba(37,99,235,0.09) 50%, rgba(29,78,216,0) 100%)",
    ...
    },
    {
        ...
        href: "/about",
        gradient:
            "radial-gradient(circle, rgba(239,68,68,0.2) 0%, rgba(220,38,38,0.09) 50%, rgba(185,28,28,0) 100%)",
    ...
    },
    {
        ...
        href: "/portfolio",
        gradient:
            "radial-gradient(circle, rgba(147,51,234,0.2) 0%, rgba(126,34,206,0.09) 50%, rgba(88,28,135,0) 100%)",
        iconColor:
    ...
    },
    {
        ...
        href: "/services",
        gradient:
            "radial-gradient(circle, rgba(20,184,166,0.2) 0%, rgba(13,148,136,0.09) 50%, rgba(15,118,110,0) 100%)",
    ...
    },
    {
        ...
        href: "/contact",
        gradient:
            "radial-gradient(circle, rgba(249,115,22,0.2) 0%, rgba(234,88,12,0.09) 50%, rgba(194,65,12,0) 100%)",
        iconColor:
